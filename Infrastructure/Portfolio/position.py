...
class Position:
    ...
    def __init__(
        ...
        self.buy_commission = round(buy_commission, 2)
        self.sell_commission = round(sell_commission, 2)
    ...
    def open_from_transaction(cls, transaction):
        ...
        current_price = round(transaction.price, 2)
        ...
        if transaction.quantity > 0:
            ...
            avg_sold = 0.0
            buy_commission = round(transaction.commission, 2)
            sell_commission = 0.0
        else:
            buy_quantity = 0
            ...
            buy_commission = 0.0
            sell_commission = round(transaction.commission, 2)
    ...
    def market_price(self):
        """
        Returns current market price. Rounded to two decimals.
    ...
    def commission(self):
        ...
        """
        return round(self.buy_commission + self.sell_commission, 2)
    ...
    def net_incl_commission(self):
        ...
        """
        return round(self.net_total - self.commission, 2)
    ...
    def unrealised_pnl(self):
        ...
        """
        return round((self.current_price - self.avg_price), 2) * self.net_quantity
    ...
    def __repr__(self):
        """
        Provides representation of the position at the specific instance.
        ...
        return f"Asset: {self.asset}, Market Price: {self.current_price}, Date: {self.current_dt}, " \
               f"Quantity: {self.net_quantity}, Market Value: {self.market_value}, " \
               f"Unrealised PL: {self.unrealised_pnl}, Realised PL: {self.realised_pnl}, Total PL {self.total_pnl}"
